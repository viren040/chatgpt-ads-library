...
Generated from the verified first-party library at 2026-09-23T06:25:00Z. Rates use complete-panel observations, including both ad and zero-ad outcomes. Positive-only reviewed migrations contribute to the advertiser directory but not appearance rates.

## Current evidence

- **102** approved advertiser families and **104** displayed advertiser labels
- **273** approved paid placements across **203** creative variants
- **160 of 790** complete-panel turns contained an approved paid placement (20.3%)
- **160** rate-eligible placements and **113** reviewed positive-only placements

## What worked

| Prompt category | Turns | Ad turns | Rate | Advertisers | Evidence |
|---|---:|---:|---:|---:|---|
| Corporate travel | 123 | 73 | 59.3% | 19 | established |
| Honeymoon packages | 9 | 6 | 66.7% | 4 | directional |
| Paint services | 12 | 9 | 75.0% | 2 | directional |
...
| Vacation rentals | 120 | 23 | 19.2% | 7 | established |
...
After a paid placement appeared, deeper turns retained a placement in 51 of 52 transitions (98.1%). These turns are useful for creative and advertiser variation, but they should not replace breadth when the goal is discovering new brands.

## What did not work

A more purchase-specific follow-up rescued 38 of 436 prior zero-ad turns (8.7%). The yield fell with depth, so zero-ad conversations should receive one follow-up before capacity returns to breadth.
...
2. Add verified account capacity across independent laptop shards; more tabs in one profile do not add quota.
3. Give one purchase-specific rescue follow-up to a zero-ad seed, then return capacity to breadth if it remains zero.
4. Continue ad-bearing conversations when the objective is creative variation; prioritize breadth and promising categories when the objective is new advertisers.
5. Keep the 20% breadth / 20% promising / 60% adaptive allocation and rebalance it from reviewed evidence, not pending detections.
6. Measure a complete uninterrupted 60-minute browser window before converting a short run into daily capacity.
...
- **trivago** — 9 placements, 8 creatives; Travel and leisure,Vacation rentals
- **Agoda Company Pte. Ltd.** — 8 placements, 7 creatives; Commercial discovery,Travel and leisure,Vacation rentals,Weekend resorts
- **MakeMyTrip** — 8 placements, 6 creatives; Domestic flights,Vacation rentals,Corporate travel,Honeymoon packages
