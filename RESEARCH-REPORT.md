...
Generated from the verified first-party library at 2026-09-23T08:43:07Z. Rates use complete-panel observations, including both ad and zero-ad outcomes. Positive-only reviewed migrations contribute to the advertiser directory but not appearance rates.

## Current evidence

- **103** approved advertiser families and **105** displayed advertiser labels
- **274** approved paid placements across **204** creative variants
- **161 of 793** complete-panel turns contained an approved paid placement (20.3%)
- **161** rate-eligible placements and **113** reviewed positive-only placements
...
| Paint services | 13 | 9 | 69.2% | 2 | directional |
...
A more purchase-specific follow-up rescued 38 of 437 prior zero-ad turns (8.7%). The yield fell with depth, so zero-ad conversations should receive one follow-up before capacity returns to breadth.
