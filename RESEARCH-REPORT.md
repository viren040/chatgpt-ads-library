...
Generated from the verified first-party library at 2026-09-23T08:47:24Z. Rates use complete-panel observations, including both ad and zero-ad outcomes. Positive-only reviewed migrations contribute to the advertiser directory but not appearance rates.
...
- **164 of 877** complete-panel turns contained an approved paid placement (18.7%)
...
|---|---:|---:|---:|---:|---|
| Corporate travel | 149 | 74 | 49.7% | 19 | established |
...
| Vacation rentals | 133 | 25 | 18.8% | 7 | established |
...
A more purchase-specific follow-up rescued 38 of 477 prior zero-ad turns (8.0%). The yield fell with depth, so zero-ad conversations should receive one follow-up before capacity returns to breadth.
